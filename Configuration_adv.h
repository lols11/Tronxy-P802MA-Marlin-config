...
// #define SD_IGNORE_AT_STARTUP            // Don't mount the SD card when starting up
 //#define SDCARD_READONLY                 // Read-only SD card (to save over 2K of flash) TODO
...
#define POWER_LOSS_MIN_Z_CHANGE 0.15 // (mm) Minimum Z change before saving power-loss data
